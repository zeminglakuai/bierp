    ...
    <div class="tabs-container">
      ...
      <div class="tab-content">
        ...
        <div id="tab-2" class="tab-pane">
            <div class="panel-body">
              <?= app\common\widgets\FileList::widget(['model'=>'supplier','file_list'=>$supplier->supplierFile]); ?>
            </div>
        </div>
        <?php if(isset($supplier->id)){ ?>
        <div id="tab-3" class="tab-pane">
            <div class="panel-body">
              <!--显示用户列表-->
              <?= app\common\widgets\ContactList::widget(['contact_list'=>$supplier->contactList]); ?>
            </div>
        </div>
        <?php } ?>
        <div id="tab-3" class="tab-pane">
