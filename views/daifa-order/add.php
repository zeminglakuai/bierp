    ...
    <div class="ibox-content" style="padding-bottom:10px;">
        <form id="order_form" class="form-horizontal m-t"  enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="col-xs-4">
                        <input type="text" id="supplier_id" class="supplier"  name="DaifaOrder[supplier_id]"  class="form-control" >
                    </div>
                </div>
            </div>
                    ...
                    $("#supplier_id").tokenInput("<?= Url::to(['/goods/search-supplier'])?>",
                        {
                            ...
                            tokenLimit:1,
                            <?php if($list->supplier_id >= 1){ ?>prePopulate:[{id:'<?= $list->supplier_id?>',name:'<?= $list->supplier_name?>'}],<?php }?>
                        }
                    );
                });
            </script>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="form-control" name="DaifaOrder[custom_id]">
...
?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="form-control" name="DaifaOrder[shipping_method]">
                        <option value="">请选择</option>
                        <?php
                        if ($shiplist){
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="DaifaOrder[materiel_fee]" class="form-control"  id=""/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label"> 运输费用</label>
                <div class="col-sm-9">
                    <input type="text" name="DaifaOrder[shipping_fee]" class="form-control"  id=""/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label"> 发货单号</label>
                <div class="col-sm-9">
                    <input type="text" name="DaifaOrder[shipping_code]" class="form-control"   id=""/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label"> 备注</label>
                <div class="col-sm-9">
                    <input type="text" name="DaifaOrder[remark]" class="form-control"  id=""/>
                </div>
            </div>
        </form>
    </div>
...
<script>
    $("#edit_export-order").click(function(){
        ...
        var update_url = create_url('/daifa-order/insert');
        $.ajax({
            url: update_url ,
            type: 'POST',
            data: formData,
