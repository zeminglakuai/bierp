...
<?= app\common\widgets\PageSearch::widget([
                      'url'=>Url::to(['purchase-return/index']),
                      'condition'=>[
                                  ['type'=>'text','label'=>'order_sn','label_name'=>'单号'],
                                  ['type'=>'text','label'=>'supplier_name','label_name'=>'供货商名称'],
                                  ['type'=>'select','label'=>'purchase_return_status','label_name'=>'单据状态','value_arr'=>ApprovalProcess::getApprovalValue($this->context->id)],
                                  ]
                      ])
?>
...
<?= app\common\widgets\DataList::widget([
                      ...
                      'title_arr'=>['id'=>1,'order_sn'=>0,'supplier_name'=>0,'returnNumber'=>0,'add_user_name'=>0,'add_time'=>0,'purchase_return_status'=>1,],
                      'search_allowed' => ['order_sn'=>2,'supplier_name'=>2,'purchase_return_status'=>1,'purchase_id'=>2],
...
<?= app\common\widgets\OperateBar::widget([
                                            'create'=>['label_name'=>'添加'.$this->context->page_title,'id'=>'create_sell_order','type'=>'js','url'=>Url::to(["purchase-return/create"])],
