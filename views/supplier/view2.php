  ...
  <div class="col-sm-12">
    <div class="tabs-container">
      <ul class="nav nav-tabs">
        ...
        <li class=""><a data-toggle="tab" href="#tab-2" aria-expanded="false">三证</a></li>
...
<script>
  ...
  $(".delete_consignee").click(function(){
    ...
    var id = $(this).attr('origin-id');
    if (confirm("确认删除？")) {
      $.get('/supplier/delete-consignee',{id:id,consignee_id:data_id},function(result){
        if (result.error == 1) {
  ...
  $(".delete_contact").click(function(){
    ...
    var id = $(this).attr('origin-id');
    if (confirm("确认删除？")) {
      $.get('/supplier/delete-contact',{id:id,contact_id:data_id},function(result){
        if (result.error == 1) {
          window.location.reload();
        }else{
          layer.msg(result.message);
