            ...
            <div class="row">
                <div class="col-sm-9">
                    ...
                    <div class="col-sm-3 m-b-1">
                        项目名称 :
                        <span>
                            <a href="javascript:void();" id="custom" data-id="24"><?= $export_order['platform_name'] ?></a>
                        </span>
                    </div>
                ...
                <div class="col-sm-3 text-right">
                    ...
                    <p>
                        <span class="padding-lr-5">创建人:<?= $export_order['add_user_name'] ?>/<?= $export_order['depart_name'] ?></span><span class="padding-lr-5">日期:<?php date("Y-m-d H:i", $export_order['add_time']); ?></span></p>
                </div>
            </div>
                                    ...
                                    <tr id="goods_row_<?= $v['goods_id'] ?>">
                                        ...
                                        <td>
                                            <div id="number_<?= $v['goods_id'] ?>" title="">
                                                <div class="lable_edit" data-id="<?= $v['goods_id'] ?>" data-type="number"><?php if ($v['number']) {
                                                                                                                                echo $v['number'];
                                                                                                                            } ?></div>
                                            </div>
                                        </td>
                                        <td>
                                            <div id="send_number_ <?= $v['goods_id'] ?>" title="">
                                                <div class="lable_edit" data-id="<?= $v['goods_id'] ?>" data-type="send_number"><?php if ($v['number']) {
                                                                                                                                    echo $v['number'];
                                                                                                                                } ?></div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <a class="delete_goods" data-id="<?= $v['goods_id'] ?>" action="delete-goods" href="javascript:void();">
