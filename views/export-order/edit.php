...
<?= app\common\widgets\OrderForm::widget(['form_data'=>[
                                                        ['type'=>'select','label_name'=>'配送方式','name'=>'ExportOrder[shipping_method]','value'=>$export_order->shipping_method,'tips','id','init_value'=>ArrayHelper::map(DictionaryValue::getValueList(5),'dictionary_value','dictionary_value'),],
                                                        ...
                                                        ['type'=>'text','label_name'=>'发货单号','name'=>'ExportOrder[shipping_code]','value'=>$export_order->shipping_code,'tips','id','init_value',],
