    ...
    <div class="tab-content">
      <div id="base_info" class="tab-pane active">
        <div class="panel-body">
          <?= app\common\widgets\Input::widget(['label_name'=>'入职人','name'=>"Accession[user_id]",'value'=>$accession->user_id,'tips'=>'','inneed'=>true]); ?>
...
<?= app\common\widgets\Submit::widget(['model'=>$platform,'model_name'=>$this->context->id,'form_name'=>'order_form']); ?>
