...
<?= app\common\widgets\OrderForm::widget(['form_data'=>[['type'=>'text','label_name'=>'付款方式','name'=>'SellOrder[pay_method]','value'=>$sell_order->pay_method,'tips','id','init_value',],
                                                        ['type'=>'text','label_name'=>'配送方式','name'=>'SellOrder[shipping_method]','value'=>$sell_order->shipping_method,'tips','id','init_value',],
