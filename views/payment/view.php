...
$this->params['breadcrumbs'][] = $payment->order_sn;
?>
...
<?= app\common\widgets\GoodsList::widget([
                      ...
                      'order_id'=>$id,
                      'model_name'=>'sell-order',
                      'init_condition'=>[['order_id'=>$payment->id]],
...
<?= app\common\widgets\OperateBar::widget([
      'create'=>['label_name'=>'添加商品','id'=>'create_sell_order_goods','type'=>'js','url'=>Url::to(["sell-order/create-goods","order_id"=>$payment->id])],
