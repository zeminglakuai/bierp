        ...
        <div class="ibox-content" style="padding:10px 5px 5px 10px;">
            ...
            <form name="" id="goods_list_form">
                ...
                <div class="x_auto_box" id="showDiv">
                    <table class="table table-hover dataTable">
                        <thead>
                            <tr style="height: 37px;display: block;width: 1500px;
">
                                    ...
                                    <div id="goods_store_info_<?= $val['goods_id'] ?>" title="">
                                        ...
                                        <td>
                                            <div id="is_priced_<?= $val['goods_id'] ?>" title="">
                                                <input type="checkbox" class="js-switch" data-url="" data-type="is_priced" data-id="<?= $val['goods_id'] ?>" id="is_priced_<?= $val['goods_id'] ?>" data-switchery="true" style="display: none;"><span class="switchery" id="is_priced_<?= $val['goods_id'] ?>" style="box-shadow: rgb(223, 223, 223) 0px 0px 0px 0px inset; border-color: rgb(223, 223, 223); transition: border 0.4s ease 0s, box-shadow 0.4s ease 0s;"><small style="left: 0px; transition: left 0.2s ease 0s;">
                                        ...
                                        <td>
                                            <div id="is_need_temp_<?= $val['goods_id'] ?>" title="">
                                                <input type="checkbox" class="js-switch" data-url="" data-type="is_need_temp" data-id="<?= $val['goods_id'] ?>" id="is_need_temp_<?= $val['goods_id'] ?>" data-switchery="true" style="display: none;"><span class="switchery" id="is_need_temp_<?= $val['goods_id'] ?>" style="box-shadow: rgb(223, 223, 223) 0px 0px 0px 0px inset; border-color: rgb(223, 223, 223); transition: border 0.4s ease 0s, box-shadow 0.4s ease 0s;"><small style="left: 0px; transition: left 0.2s ease 0s;"></small></span>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a class="delete_goods" data-id="<?= $val['goods_id'] ?>" action="delete-goods" href="javascript:void();">
