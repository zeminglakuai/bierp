...
<?= app\common\widgets\GoodsList::widget([
                      ...
                      'title_arr'=>['goods_name'=>['sort_able'=>0,'edit_able'=>0,'width'=>'180px'],
                                    ...
                                    'goods_store_info'=>['sort_able'=>0,'edit_able'=>0,'width'=>'90px'],
                                    ...
                                    'is_priced' => ['sort_able'=>1,'edit_able'=>1,'width'=>'70px','type'=>'switch'],
                                    'shipping_to_place' => ['sort_able'=>0,'edit_able'=>1,'width'=>'70px'],
                                    'is_need_temp' => ['sort_able'=>1,'edit_able'=>1,'width'=>'70px','type'=>'switch'],
                                    'remark' => ['sort_able'=>0,'edit_able'=>1,'width'=>'100px'],
...
<?= app\common\widgets\OperateBar::widget([
                                            ...
                                            'export_ppt'=>['label_name'=>'导出','module_name'=>'custom-order','type'=>'detail','id'=>$custom_order->id],
