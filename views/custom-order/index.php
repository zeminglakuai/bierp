...
$this->params['breadcrumbs'][] = 'B2B方案列表';
?>
<?= app\common\widgets\PageSearch::widget([
                      ...
                      'condition'=>[
                                  ...
                                  ['type'=>'text','label'=>'custom_name','label_name'=>'客户'],
...
<?= app\common\widgets\OperateBar::widget([
                                            'create'=>['label_name'=>'添加B2B方案','id'=>'create_custom_order','type'=>'js','url'=>Url::to(["custom-order/create"])],
