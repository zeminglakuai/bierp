...
<div class="ibox">
    <div class="ibox-content" style="padding-bottom:10px;">
        <form id="order_form" class="form-horizontal m-t">
            <?= app\common\widgets\Select::widget(['label_name'=>'项目名称','name'=>"Purchase[project_id]",'value'=>$purchase->project_id,'init_value'=>ArrayHelper::map(Project::getValueList(),'project_id','project_name'),'tips'=>'']); ?>
            ...
            <?= app\common\widgets\Select::widget(['label_name'=>'收货仓库','name'=>"Purchase[store_id]",'value'=>$purchase->store_id,'init_value'=>ArrayHelper::map(Store::find()->all(),'id','store_name'),'tips'=>'']); ?>
            <?php // app\common\widgets\Input::widget(['label_name'=>'平台备注','name'=>"Purchase[platform_beizhu]",'value'=>$purchase->platform_beizhu,'tips'=>'']); ?>
