...
<?= app\common\widgets\OrderForm::widget(['form_data'=>[
        ['type'=>'select','label_name'=>'付款方式','name'=>'Purchase[pay_method]','value'=>$purchase->pay_method,'tips','id','init_value'=>ArrayHelper::map(DictionaryValue::getValueList(4),'dictionary_value','dictionary_value'),],
    ...
    ['type'=>'select','label_name'=>'结算方式','name'=>'Purchase[pay_type]','value'=>$purchase->pay_type,'tips','id','init_value'=>ArrayHelper::map($pay_type,'id','val'),],
    ['type'=>'select','label_name'=>'采购类型','name'=>'Purchase[pay_type]','value'=>$purchase->purchase_type,'tips','id','init_value'=>ArrayHelper::map($purchase_type,'id','val'),],
