...
<?= app\common\widgets\PageSearch::widget([
                      ...
                      'condition'=>[
                                  ['type'=>'text','label'=>'user_real_name','label_name'=>'申请人'],
                                  ['type'=>'select','label'=>'leave_status','label_name'=>'审核状态','value_arr'=>ApprovalProcess::getApprovalValue($this->context->id)],
                                  ]
                      ])
?>

<?= app\common\widgets\DataList::widget([
                      'model'=>'app\common\models\Leave',
                      'model_name'=>$this->context->id,
                      'title_arr'=>['id'=>1,'real_name'=>0,'user_real_name'=>0,'add_user_name'=>0,'depart_name'=>0,'add_time'=>0,'status_name'=>0,],
                      'search_allowed' => ['add_user_name'=>2,'leave_status'=>1],
