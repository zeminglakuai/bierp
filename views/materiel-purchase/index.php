...
<?= app\common\widgets\PageSearch::widget([
                      'url'=>Url::to(['materiel-purchase/index']),
                      'condition'=>[
                                  ['type'=>'text','label'=>'order_sn','label_name'=>'单号'],
                                  ['type'=>'text','label'=>'supplier_name','label_name'=>'供货商名称'],
                                  ['type'=>'select','label'=>'purchase_status','label_name'=>'单据状态','value_arr'=>ApprovalProcess::getApprovalValue($this->context->id)],
                                  ]
                      ])
?>
...
<?= app\common\widgets\DataList::widget([
                      ...
                      'title_arr'=>['id'=>1,'order_sn'=>0,'supplier_name'=>0,'add_user_name'=>0,'add_time'=>0,'materiel_purchase_status'=>1,'store_name'=>0],
                      'search_allowed' => ['order_sn'=>2,'supplier_name'=>2,'materiel_purchase_status'=>1],
...
<?= app\common\widgets\OperateBar::widget([
                                            'create'=>['label_name'=>'添加'.$this->context->page_title,'id'=>'materiel_purchase','type'=>'js','url'=>Url::to(["materiel-purchase/create"])],
