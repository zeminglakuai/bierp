...
<?= app\common\widgets\PageSearch::widget([
                      'url'=>Url::to(['sell-invoice/index']),
                      'condition'=>[
                                  ['type'=>'text','label'=>'order_sn','label_name'=>'发票单号'],
                                  ['type'=>'text','label'=>'relate_order_sn','label_name'=>'销售单据'], 
                                  ['type'=>'text','label'=>'title','label_name'=>'抬头'],
                                  ['type'=>'select','label'=>'sell_invoice_status','label_name'=>'发票状态','value_arr'=>ApprovalProcess::getApprovalValue($this->context->id)],                   
                                  ]
                      ])
?>
...
<?= app\common\widgets\DataList::widget([
                      ...
                      'model_name'=>'sell-invoice',
                      'title_arr'=>['id'=>1,'order_sn'=>0,'relate_order_sn'=>0,'order_total'=>0,'title'=>0,'fee'=>0,'remain_time'=>0,'add_user_name'=>0,'add_time'=>0,'status_name'=>1],
                      'search_allowed' => ['order_sn'=>2,'title'=>2,'sell_invoice_status'=>1,'relate_order_sn'=>2],
...
<?= app\common\widgets\OperateBar::widget([
                                            'create'=>['label_name'=>'添加'.$this->context->page_title,'id'=>'create_sell_invoice','type'=>'js','url'=>Url::to(["sell-invoice/create"])],
