                  ...
                  <script type="text/javascript">
                    $(document).ready(function() {
                        $("#brand").tokenInput(<?= Brand::getTokeninputlist() ?>,
                          {
                            theme:'facebook',
                            <?php if($brand_id >= 1){ ?>prePopulate:[{id:'<?= $brand_id ?>',name:'<?= $brand->brand_name?>'}],<?php }?>
                            hintText:'请输入要搜索的关键字',
                            tokenLimit:1
                          }
                        );
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              ...
              <input type="text" name="supplier_name" value="<?= $supplier_name?>" class="form-control"  placeholder="供货商"/>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
    ...
    <table class="table table-hover dataTable">
      <thead>
        <tr>
          ...
          <th width="5%" align="center" class="<?php if($sortby == 'shop_price'){if($order==4){echo 'sorting_asc';}else{echo 'sorting_desc';}}else{echo 'sorting';}?> user_sort" data-type="shop_price">销售价</th>
          <th width="5%" align="center" class="<?php if($sortby == 'market_price'){if($order==4){echo 'sorting_asc';}else{echo 'sorting_desc';}}else{echo 'sorting';}?> user_sort" data-type="market_price">市场价</th>
          ...
          <th width="10%" align="center">供货商</th>
            ...
            <th width="5%" align="center">滞销天数</th>
        ...
        <tr>
          ...
          <td>
            <A href="<?= Url::to(['/goods/view','goods_id'=>$vv['goods_id'],'type'=>$type])?>"><span class="glyphicon glyphicon-cog"></span> 编辑</A>
             ...
             <?php }
              ?>
<!--            <A href="javascript:void();" class="show_custom_order" data-id="--><?//= $vv['goods_id']?><!--"><span class="glyphicon glyphicon-eye-open"></span> 参加项目</A>-->
