                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-9">
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function() {
                                            $("#brand").tokenInput(<?= Brand::getTokeninputlist() ?>, {
                                                theme: 'facebook',
                                                <?php if ($goods->brand_id >= 1) { ?>prePopulate: [{
                                                    id: '<?= $goods->brand_id ?>',
                                                    name: '<?= $goods->brand->brand_name ?>'
                                                }],
                                            <?php } ?>
                                            hintText: '请输入要搜索的关键字',
                                            tokenLimit: 1
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="Goods[market_price]" size="20" class="form-control" spaceholder="销售指导价" value="<?= $goods->market_price ?>" />
                                </div>
                            </div>
