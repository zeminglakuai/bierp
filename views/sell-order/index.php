...
$this->params['breadcrumbs'][] = '销售单据';
?>
<?= app\common\widgets\PageSearch::widget([
                      'url'=>Url::to(['sell-order/index']),
                      'condition'=>[
                                  ['type'=>'text','label'=>'order_sn','label_name'=>'单号'],
                                  ['type'=>'text','label'=>'custom_name','label_name'=>'客户名称'],
                                  ['type'=>'select','label'=>'sell_order_status','label_name'=>'审核状态','value_arr'=>ApprovalProcess::getApprovalValue($this->context->id)],
                                  ]
                      ])
?>
...
<?= app\common\widgets\DataList::widget([
                      ...
                      'title_arr'=>['id'=>1,'order_sn'=>0,'custom_name'=>0,'customOrder&order_name'=>0,'goodsNumber'=>0, 'total'=>0,'add_user_name'=>0,'add_time'=>0,'sell_order_status'=>1,'shipping_status'=>1,'return_status'=>1],
...
<?= app\common\widgets\OperateBar::widget([
                                            'create'=>['label_name'=>'添加销售单据','id'=>'create_sell_order','type'=>'js','url'=>Url::to(["sell-order/create"])],
