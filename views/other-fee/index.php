...
<?= app\common\widgets\PageSearch::widget([
                      ...
                      'condition'=>[
                                  ...
                                  ['type'=>'select','label'=>'fee_ttype_name','label_name'=>'费用类型','value_arr'=>ArrayHelper::map(DictionaryValue::getValueList(12),'dictionary_value','dictionary_value')],
                                  ['type'=>'select','label'=>'other_fee_status','label_name'=>'审核状态','value_arr'=>ApprovalProcess::getApprovalValue($this->context->id)],
                                  ]
                      ])
?>

<?= app\common\widgets\DataList::widget([
                      'model'=>'app\common\models\OtherFee',
                      'model_name'=>$this->context->id,
                      'title_arr'=>['id'=>1,'order_sn'=>0,'fee'=>0,'fee_ttype_name'=>0,'fee_couse'=>0,'add_user_name'=>0,'depart_name'=>0,'add_time'=>0,'status_name'=>0,],
                      'search_allowed' => ['order_sn'=>2,'add_user_name'=>2,'fee_ttype_name'=>1,'other_fee_status'=>1],
