...
<?= app\common\widgets\GoodsList::widget([
                      ...
                      'title_arr'=>[
                                    'goods_name'=>['sort_able'=>0,'edit_able'=>0,'width'=>'25%'],
                                    'goods_sn'=>['sort_able'=>0,'edit_able'=>0,'width'=>'13%'],
                                    'isbn'=>['sort_able'=>0,'edit_able'=>0,'width'=>'10%'],
                                    'market_price'=>['sort_able'=>0,'edit_able'=>0,'width'=>'13%'],
                                    'number'=>['sort_able'=>1,'edit_able'=>0,'width'=>'5%','total'=>true],
                                    /*'goods_store_info'=>['sort_able'=>0,'edit_able'=>0,'width'=>'10%'],
                                    'store_code'=>['sort_able'=>0,'edit_able'=>0,'width'=>'10%'],*/
...
<?= app\common\widgets\OperateBar::widget([
      'create'=>['label_name'=>'添加商品','id'=>'create_sell_order_goods','type'=>'js','url'=>Url::to(["import-order/create-goods","order_id"=>$import_order->id])],
