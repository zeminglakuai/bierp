...
<?= app\common\widgets\PageSearch::widget([
                      ...
                      'condition'=>[
                                  ...
                                  ['type'=>'select','label'=>'import_order_status','label_name'=>'单据状态','value_arr'=>ApprovalProcess::getApprovalValue($this->context->id)], 
                                  ]
                      ])
?>

<?= app\common\widgets\DataList::widget([
                      'model'=>'app\common\models\ImportOrder',
                      'model_name'=>$this->context->id,
                      'title_arr'=>['id'=>1,'order_sn'=>0,'supplier_name'=>0,'purchase_sn'=>0,'store_name'=>0,'add_user_name'=>0,'add_time'=>0,'import_order_status'=>1,],
                      'search_allowed' => ['order_sn'=>2,'supplier_name'=>2,'import_order_status'=>1,'store_id'=>1],
...
<?= app\common\widgets\OperateBar::widget([
    'create'=>['label_name'=>'添加商品','id'=>'create_sell_order_goods','type'=>'js','url'=>Url::to(["create-goods-store"])],
                                            'export'=>['label_name'=>'导出','module_name'=>$this->context->id,'type'=>'detail','id'=>$import_order->id],
