...
class LinkPager extends Widget
{
    ...
    protected function renderPageButtons()
    {
        ...
        $buttons[] = $this->renderPageButton('共计'.$this->pagination->totalCount.'条记录', 0, 'disabled', false, false);
        $buttons[] = $this->renderPageButton('共计'.$pageCount.'页', 0, 'disabled', false, false);
