...
class CustomController extends BaseController
{
  ...
  public function actionInsert()
  {
    ...
    $Custom->add_user_id = Yii::$app->session['manage_user']['add_user_id'];
    $Custom->add_user_name = Yii::$app->session['manage_user']['add_user_name'];
    $Custom->depart_id = Yii::$app->session['manage_user']['depart_id'];
    $Custom->depart_name = Yii::$app->session['manage_user']['depart_name'];
    $Custom->add_time = time();
    $Custom->save(false);
