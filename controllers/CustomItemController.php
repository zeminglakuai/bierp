...
use app\common\models\CustomItem;
use yii\helpers\Url;
...
class CustomItemController extends BaseController
{
    ...
    public $page_title = '客户项目';

    public $title_model = 'app\common\models\CustomItem';
    public $status_label = 'custom_item_status';
    ...
    public function beforeAction($action)
    {
      ...
      $status_label = 'custom_item_status';
