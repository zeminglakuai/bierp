...
use app\common\models\MaterielRequest;
...
class MaterielRequestController extends BaseController
{
    public $page_title = '物料申请';
    public $title_model = 'app\common\models\MaterielRequest';
    public $detail_model = 'app\common\models\MaterielRequestGoods';
    public $status_label = 'materiel_request_status';
    ...
    public function beforeAction($action)
    {
      ...
      $scope_model = 'app\common\models\MaterielRequest';
    ...
    public function actionInsert(){
        $MaterielRequest = new MaterielRequest();
        $MaterielRequest->load(Yii::$app->request->post());
        $MaterielRequest->order_sn = Common_fun::create_sn('app\common\models\MaterielRequest',5);
