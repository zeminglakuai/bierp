...
class Contract extends BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['content'], 'string'],
            [['order_sn', 'order_id', 'add_time', 'add_user_name', 'depart_name', 'remark', 'admit_user_name','keeper_user_name','keep_time', 'admit_time', 'custom_name', 'contract_name', 'relate_order_sn', 'end_time', 'start_time'], 'string', 'max' => 255],
        ];
    }
    ...
    {
        return $this->hasMany(FileInfo::classname(),['belong_id'=>'id'])->where(['model'=>'contract']);
    }
