...
class Purchase extends BaseModel
{
    ...
    {
        return [
            [['supplier_id', 'purchase_status', 'admit_user_id','return_status', 'period', 'add_user_id','pay_status','store_id', 'depart_id','invoice_status','sell_order_id','pay_type','purchase_type','pack_num','fid'], 'integer'],
