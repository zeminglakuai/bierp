...
class Purchase extends BaseModel
{
    ...
    {
        return [
            [['supplier_id', 'purchase_status', 'admit_user_id','return_status', 'period', 'add_user_id','pay_status','store_id', 'depart_id','invoice_status','sell_order_id','pay_type','purchase_type','platform_id'], 'integer'],
            [['order_name','consignee','consignee_tel','address', 'add_time', 'admit_time', 'order_sn','sell_order_sn', 'supplier_name','pay_method','shipping_method','store_name', 'remark', 'admit_user_name', 'add_user_name', 'depart_name','platform_beizhu','platform_name'], 'string', 'max' => 255]
        ];
    }
