    ...
    <div class="row">
      <div class="col-sm-9">
          ...
          ?>
              ...
              <?php  }elseif ( $key == 'qcode') {?>

<div style="background-color: #fff;"><img src="<?= $model->$key;?>" width="40px" /></div>
              <?php
      ...
      <div class="col-sm-3 text-right">
          ...
          if ( $key == 'qcode') {?>
            ...
            <div style="background-color: #fff;"><img src="<?php echo $purchase['qcode'];?>" width="40px" /></div>
            <?php } 
